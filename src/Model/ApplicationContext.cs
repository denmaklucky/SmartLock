...
public class ApplicationContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UserRole>().HasData(new UserRole{UserId = Guid.Parse("02387541-4280-4d14-86d9-9386310de6ce"), RoleId = Guid.Parse("6b22b9a0-bc42-4b88-96ef-a0c4539d6dac")});
        modelBuilder.Entity<UserRole>().HasData(new UserRole{UserId = Guid.Parse("a96fe69e-cc4c-45a8-a05d-dc498368a766"), RoleId = Guid.Parse("2e1d11bf-e1f6-4eb8-9042-5fd6a4bbf6e2")});
